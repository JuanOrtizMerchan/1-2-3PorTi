    ...
    <body class="body">
        ...
        <div class="fom-group body-font">
            ...
            <ul class="pos">
                ...
                <div>  
                    <form action="userQuery.htm" method="post">
                      <div class="form-group">
                       
                                             <label>Identificación</label>
                                              <input type="text" class="form-control" id="identificacion" name="identificacion" value="">
                                            </div>
                                            <div class="form-group">
                                               <label>Nombre</label>
                                            ...
                                            <button class="btn btn-danger" style="background-color: #8A1583">Verificar datos</button>
                                            </div>
                          </form>
                                              <center>
                                                  <p>${mensaje}</p>
